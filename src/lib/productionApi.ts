...
import { hasActiveGraphicConfiguration } from './cinematicPolicy';
...
export function partitionReusableDirections(existing:SceneDirection[],targetScenes:TimedScene[],targetPlan:PlannedScene[],state:Pick<AppState,'topic'>,model:string,persistentContext:ProductionContext|null,options:{sceneReviews?:SceneReviewItem[];preserveLegacySceneNumbers?:Set<number>}={}){
